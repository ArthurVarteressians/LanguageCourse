...
print("Generating MP3 files with improved male German and female English voices for chunks of 10 rows...")
...
for i in range(num_chunks):
    ...
    for idx in range(start_idx, end_idx):
        ...
        combined_audio += AudioSegment.silent(duration=pause_after_english)  # Pause after English word
...
print("\nAll chunked MP3 files with improved male German and female English voices generated successfully!")
